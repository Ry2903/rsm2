 ...
 */
void movimentarMotores(int EnableMotor1, int EnableMotor2, int state1, int state2, int state3, int state4);
...
void loop() 
{
  ...
  {
    movimentarMotores(LOW, LOW, LOW, LOW);
...
void processarComando(char comando)
{
  ...
  {
    case 'F': // Frente
      movimentarMotores(HIGH, LOW, HIGH, LOW);
      Serial.println("Frente");
      break;

    case 'R': // Ré
      movimentarMotores(LOW, HIGH, LOW, HIGH);
      Serial.println("Ré");
      break;

    case 'D': // Direita
      movimentarMotores(LOW, HIGH, HIGH, LOW);
      Serial.println("Direita");
      break;

    case 'E': // Esquerda
      movimentarMotores(HIGH, LOW, LOW, HIGH);
 ...
 * @param state4 Estado do pino IN4.
 */
void movimentarMotores(int state1, int state2, int state3, int state4)
{
